...
当用户说自己对于zxcode的新增功能的初步想法的时候，要用「生成spec三份文档的模板生成spec三份文档的模板工作流」，生成的三份文档放在根目录的docs目录下

## 生成spec三份文档的模板工作流

```text
我正在构建一个终端 AI 编程助手（类似 Claude Code），项目名叫 ZXCode，使用的编程语言是
【python】。

我有一个初步的想法，需要你通过向我提问，帮助我澄清需求、挖掘边缘场景。澄清清楚后共创三份文档保存到项目根目录：
